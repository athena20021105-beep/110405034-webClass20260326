      ...
      <body className="min-h-full flex flex-col">
        ...
        <div className="flex h-full">
          ...
          <div className="bg-gray-200 w-[320px] h-full p-4">
            ...
            <div className="bg-gray-300 p-[16px] mt-2 rounded-md">插畫專案</div>
